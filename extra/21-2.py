...
for word in list1:
    ...
    for char in word:
        if char in ensedadi:
            ...
            category_word = category_word + 'V1@@V3'
        elif char == 'e':
            category_word = category_word + 'V1@@V4'
        elif char == 'i':
            category_word = category_word + 'V1@@V5'
        elif char == 'A':
            category_word = category_word + 'V2@@V3'
        elif char == 'o':
            category_word = category_word + 'V2@@V4'
        elif char == 'u':
            category_word = category_word + 'V2@@V5'
        else:
            #print('oooooooooooooo', word)
            continue
...
for cat in list8:
    if len(cat) == 16:
        #print(cat)
        first_sylb.append(str(cat[:8]))
        second_sylb.append(str(cat[8:]))
        list_of_consonants.append(str(cat[:2])+str(cat[8:10]))
        list_of_vowels.append(str(cat[2:8])+str(cat[10:]))
        try:
            dict3[cat] += 1
        except:
            dict3[cat] = 1
#print('leeeeeeeeeeeeeeeeeeen', len(dict3))
...
print('most common Cs in CV.CV: ', dict4.most_common(1))
...
for C in ['C1', 'C2', 'C3', 'C4']:
    for V in ['V1@@V3', 'V1@@V4', 'V1@@V5', 'V2@@V3', 'V2@@V4', 'V2@@V5']:
...
list_of_gaps_vows = []
for V1 in ['V1@@V3', 'V1@@V4', 'V1@@V5', 'V2@@V3', 'V2@@V4', 'V2@@V5']:
    for V2 in ['V1@@V3', 'V1@@V4', 'V1@@V5', 'V2@@V3', 'V2@@V4', 'V2@@V5']:
